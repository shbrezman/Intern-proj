...
export class UserService {
  ...
  getUser<T>(phoneNumber: String): Observable<UserModel> {
    return this.http
      .get<UserModel>(this.baseUrl + 'auth/getUser/' + phoneNumber)
      .pipe(
        tap((user) => {
  ...
  getAllUsers<T>(
    ...
    return this.http.post<UserModel[]>(
      this.baseUrl + 'api/users/getAllUsers',
  ...
  sendSms(): Observable<Object> {
    return this.http.post(this.baseUrl + 'auth/sendSms', {
      from: 'Intern Academy',
      to: this.currentUser.phoneNumber,
      text: `Hello ${this.currentUser.name}, your code is: `,
    });
  }
  ...
  updateUsers(idArr): Observable<any> {
    return this.http.put(
      this.baseUrl + 'api/users/updateUsers',
      { idArr },
      this.getOptions()
    );
  }
  ...
  updateUser(id: string, tests): Observable<any> {
    return this.http.put(
      this.baseUrl + 'api/users/updateUser',
      { id: id, tests: tests },
      this.getOptions()
    );
  }
